...
<?php else: ?>
    ...
    ?>
    <h2>Alignments</h2>
    <script>const projectId = "<?= esc($id) ?>";</script>

    <div id="alignments"></div>


    <!-- <PRE><//?= $results['alignments'] ?></PRE> -->
    <?php /*foreach ($blocks as $block): if ($block != ''): ?>

            <div class="card mb-4">
                <div class="card-header text-primary small">
                    <?= esc(strtok(trim($block), "\n")) ?>
                </div>
    ...
    <?php // include modal edit_sequence ?>
